...
class FvqaTrainDataset(Dataset):
    def __init__(self, config, overfit=False, in_memory=True):
        ...
        sem_data = np.load('fvqa_data/train/semantic_graph_train_feature.npz', allow_pickle=True)
        ...
        fact_data = np.load('fvqa_data/train/fact_graph_train_feature.npz', allow_pickle=True)
